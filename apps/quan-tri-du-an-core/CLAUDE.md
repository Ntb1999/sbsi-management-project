...
This file provides guidance to Claude Code (claude.ai/code) when working in this app (`apps/quan-tri-du-an-core`). See the monorepo root `CLAUDE.md` first for repo-wide conventions — this file only covers what's specific to this app.
